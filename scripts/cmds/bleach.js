...
async function animeSong(api, event, args, message) {
    ...
    try {
        const animeSongResponse = await axios.get("https://bleach-edit.vercel.app/kshitiz");
        ...
        const writer = fs.createWriteStream(path.join(__dirname, "cache", `bleach.mp4`));
...
module.exports = {
    config: {
        ...
        countDown: 10,
        role: 0,
        shortDescription: "bleach",
        longDescription: "get bleach anime edits",
        category: "anime",
        guide: "{p}bleach"
    },
